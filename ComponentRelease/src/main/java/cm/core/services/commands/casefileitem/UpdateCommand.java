...
/**
 * <p>
 * Encapsulates the <code>update</code> transition of {@link CaseFileItem}s as a
 ...
 *
 */
public class UpdateCommand implements CaseFileItemTransitionCommand {

	private CaseFileItem cfi;

	public UpdateCommand(CaseFileItem cfi) {
		this.cfi = cfi;
	}

	@Override
	public void execute() {
		this.cfi.getContextState().update();
