...
/**
 * <p>
 * Encapsulates the <code>reEnable</code> transition of {@link CaseModel}s as a
 ...
 *
 */
public class ReEnableCommand implements TaskTransitionCommand {

	private Task task;

	public ReEnableCommand(Task t) {
		this.task = t;
	}

	@Override
	public void execute() {
		this.task.getContextState().reEnable();
	}
