...
/**
 * <p>
 * Encapsulates the <code>disable</code> transition of {@link CaseModel}s as a
 ...
 *
 */
public class DisableCommand implements TaskTransitionCommand {

	private Task task;

	public DisableCommand(Task t) {
		this.task = t;
	}

	@Override
	public void execute() {
		this.task.getContextState().disable();
	}
