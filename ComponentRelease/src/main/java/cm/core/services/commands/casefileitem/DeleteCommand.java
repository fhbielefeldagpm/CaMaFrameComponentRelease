...
/**
 * <p>
 * Encapsulates the <code>delete</code> transition of {@link CaseFileItem}s as a
 ...
 *
 */
public class DeleteCommand implements CaseFileItemTransitionCommand {

	private CaseFileItem cfi;

	public DeleteCommand(CaseFileItem cfi) {
		this.cfi = cfi;
	}

	@Override
	public void execute() {
		this.cfi.getContextState().delete();
