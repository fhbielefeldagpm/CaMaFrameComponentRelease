...
/**
 * <p>
 * Encapsulates the <code>enable</code> transition of {@link CaseModel}s as a
 ...
 *
 */
public class EnableCommand implements TaskTransitionCommand {

	private Task task;

	public EnableCommand(Task t) {
		this.task = t;
	}

	@Override
	public void execute() {
		this.task.getContextState().enable();
	}
