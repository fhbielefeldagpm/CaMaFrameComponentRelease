...
/**
 * <p>
 * Encapsulates the <code>resume</code> transition of {@link CaseModel}s as a
 ...
 *
 */
public class ResumeCommand implements TaskTransitionCommand {

	private Task task;

	public ResumeCommand(Task t) {
		this.task = t;
	}

	@Override
	public void execute() {
		this.task.getContextState().resume();
	}
