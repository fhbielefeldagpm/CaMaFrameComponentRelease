...
/**
 * <p>
 * Encapsulates the <code>replace</code> transition of {@link CaseFileItem}s as a
 ...
 *
 */
public class ReplaceCommand implements CaseFileItemTransitionCommand {

	private CaseFileItem cfi;

	public ReplaceCommand(CaseFileItem cfi) {
		this.cfi = cfi;
	}

	@Override
	public void execute() {
		this.cfi.getContextState().replace();
