...
/**
 * <p>
 * Encapsulates the <code>manualStart</code> transition of {@link CaseModel}s as
 ...
 *
 */
public class ManualStartCommand implements TaskTransitionCommand {

	private Task task;

	public ManualStartCommand(Task t) {
		this.task = t;
	}

	@Override
	public void execute() {
		this.task.getContextState().manualStart();
	}
