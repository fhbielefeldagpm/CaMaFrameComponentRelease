...
/**
 * <p>
 * Represents the RequiredRule/required decorator in CMMN. Has a reference to a
 * {@link CaseFileItem}. The actual implementation is based on class
 * {@link RuleExpression}.
 * </p>
 * <p>
 * See CMMN 1.1 specification sections 6.13.3 and 8.6.4 for more information.
 * </p>
 * 
 * @author André Zensen
...
public class RequiredRule extends Rule {
	...
	/**
	 * <p>
	 * Constructs a new RequiredRule object serving as a link to the implementation
	 ...
	 */
	public RequiredRule(String name, CaseFileItem contextRef) {
