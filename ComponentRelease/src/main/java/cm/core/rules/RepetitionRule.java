...
/**
 * <p>
 * Represents the RepetitionRule/repetition decorator in CMMN. Has a reference
 * to a {@link CaseFileItem}. The actual implementation is based on class
 * {@link RuleExpression}.
 * </p>
 * <p>
 * See CMMN 1.1 specification sections 6.13.4 and 8.6.4 for more information.
 * </p>
 * 
 * @author André Zensen
...
public class RepetitionRule extends Rule {
	...
	/**
	 * <p>
	 * Constructs a new RepetitionRule object serving as a link to the
	 * implementation and a CaseFileItem to evaluate.
	 * </p>
	 * 
	 * @param name
	 ...
	 */
	public RepetitionRule(String name, CaseFileItem contextRef) {
