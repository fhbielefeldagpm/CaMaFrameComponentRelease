...
/**
 * <p>
 * Represents state COMPLETED of {@link Stage}s and {@link Task}s. Used in the
 ...
 * @author André Zensen
 */
public class StageTaskCompleted extends StageTaskState implements IStageTaskState {

	public StageTaskCompleted(CaseElement element) {
		super(element);
	}
