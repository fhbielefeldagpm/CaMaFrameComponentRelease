...
/**
 * <p>
 * Represents state DISABLED of {@link Stage}s and {@link Task}s. Used in the
 ...
 * @author André Zensen
 */
public class StageTaskDisabled extends StageTaskState implements IStageTaskState {

	public StageTaskDisabled(CaseElement element) {
		super(element);
	}
