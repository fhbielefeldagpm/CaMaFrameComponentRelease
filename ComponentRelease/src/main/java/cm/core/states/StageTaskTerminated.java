...
/**
 * <p>
 * Represents state TERMINATED of {@link Stage}s and {@link Task}s. Used in the
 ...
 * @author André Zensen
 */
public class StageTaskTerminated extends StageTaskState implements IStageTaskState {

	public StageTaskTerminated(CaseElement element) {
		super(element);
	}
