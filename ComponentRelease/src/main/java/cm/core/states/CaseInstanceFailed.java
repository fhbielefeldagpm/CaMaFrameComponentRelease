...
/**
 * <p>
 * Represents state FAILED of {@link CaseModel}s. Used in the context of an
 ...
 * @author André Zensen
 */
public class CaseInstanceFailed extends CaseInstanceState implements ICaseInstanceState {

	public CaseInstanceFailed(CaseModel element) {
		super(element);
	}
