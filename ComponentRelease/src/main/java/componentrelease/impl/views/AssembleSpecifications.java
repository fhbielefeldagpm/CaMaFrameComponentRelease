...
@CDIView("assemble")
public class AssembleSpecifications extends CustomComponent implements View {
	...
	private Button generateBackButton() {
		...
		button.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				navigationEvent
						.fire(new NavigationEvent(Conventions.deriveMappingForView(AssembleSpecifications.class)));
			}
		});
		return button;
	}
