...
public class RequiredProvideDataTask extends RuleExpression {

	public RequiredProvideDataTask(Rule rule) {
		super(rule);
	}
	...
	public boolean evaluate() {
		...
		if(Boolean.valueOf(caseFileItem.getProperty("dataApproved").getValue())) {
			return true;
		}		
		return false;
	}
