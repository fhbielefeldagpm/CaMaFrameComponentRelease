...
public class RepeatReviewTask extends RuleExpression {

	public RepeatReviewTask(Rule rule) {
		super(rule);
	}
	...
	public boolean evaluate() {
		...
		boolean dataApproved = Boolean.valueOf(caseFileItem
				.getProperty("dataApproved").getValue());
		if(dataApproved) {
			return false;
		} else {
			return true;
